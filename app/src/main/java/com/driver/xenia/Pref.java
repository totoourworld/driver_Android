...
public class Pref {
    ...
    public String TRIP_TOTAL_DURATION = "totalduration";
...
//    public String TRIP_PAY_AMOUNT="trip_pay_amount";
    ...
    public  void setTripTotalDuration(String calculatedDistance){
        edit().putString(TRIP_TOTAL_DURATION,calculatedDistance).commit();
    }

    public String getTripTotalDuration(){
        return sharedPreferences.getString(TRIP_TOTAL_DURATION,"");
    }
