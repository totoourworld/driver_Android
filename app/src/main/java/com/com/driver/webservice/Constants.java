...
public interface Constants {
    ...
    public static final String DRIVER_BASE_URL = "http://34.217.9.8/xeniaAPI/1.0.1/index.php";
    ...
    public static final String IMAGE_BASE_URL = "http://appicial.com/HireTaxi/images/originals/";
...
//    public static final String ANDROID_NOTIFICATION_URL = "http://35.160.185.249/Taxi1.2/push/RiderAndroidPushNotification.php?";
    ...
    public interface Urls {
        public final String URL_BASE = "http://34.217.9.8/xeniaAPI/1.0.1/index.php";
        public final String URL_DRIVER_REGISTER = URL_BASE + "/driverapi/registration?";
        public final String URL_DRIVER_LOGIN = URL_BASE + "/driverapi/login?";
        public final String URL_ACCEPT_TRIP_REQUEST = URL_BASE + "/tripapi/tripaccept?";
        public final String URL_TO_SHARE = "https://play.google.com/store/apps/details?id=com.driver.xenia&hl=en";
        String EMAIL_FOR_SUPPORT = "info@appicial.com";
        public final String URL_CREATE_TRIP = URL_BASE +"/tripapi/save?";
