    ...
    public class CustomTrip {
        ...
        public static void startCustomTrip(Context context, TripModel tripModelTemp, double latitude, double longitude, Controller controller, com.driver.xenia.CustomTripUtil.CustomTripCallback customTripCallback) {
            fatchAddress(context,tripModelTemp,latitude,  longitude,controller,customTripCallback);
        }


        private static void fatchAddress(final Context context, final TripModel tripModelTemp, final double lat, final double lng, final Controller controller, final com.driver.xenia.CustomTripUtil.CustomTripCallback customTripCallback) {
        ...
        private static void StartTrip(final Context context, final TripModel tripModelTemp, final double lat, final double lng, final Controller controller, final com.driver.xenia.CustomTripUtil.CustomTripCallback customTripCallback, String locationAddress) {
